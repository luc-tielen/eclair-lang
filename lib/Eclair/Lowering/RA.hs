...
import Data.Functor.Foldable hiding (fold, hoist)
...
-- TODO: Is this index always correct? Maybe different order of columns is fine too?
mkFindIndex :: [a] -> Index
mkFindIndex values =
  Index $ SearchSignature $ Set.fromList $ zipWith const [0..] values
